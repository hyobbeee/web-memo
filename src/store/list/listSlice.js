...
export const getList = createAsyncThunk("GET_LIST", async () => {
  try {
    const res = await axios.get("https://my-json-server.typicode.com/hyobbeee/web-memo/list");
    return res.data;
  } catch (err) {
    console.log(err);
  }
...
export const addList = createAsyncThunk("ADD_LIST", async (newList) => {
  try {
    const res = await axios.post(`https://my-json-server.typicode.com/hyobbeee/web-memo/list`, newList);
    return res.data;
  } catch (err) {
    console.log(err);
  }
...
export const deleteList = createAsyncThunk("DELETE_LIST", async (id) => {
  try {
    const res = await axios.delete(`https://my-json-server.typicode.com/hyobbeee/web-memo/list/${id}`);
    return id;
  } catch (err) {
    console.log(err);
  }
...
export const updateList = createAsyncThunk("UPDATE_LIST", async ({ id, content }) => {
  try {
    const res = await axios.put(`https://my-json-server.typicode.com/hyobbeee/web-memo/list/${id}`, {
      content: content,
    });
    return { id, content };
  } catch (err) {
